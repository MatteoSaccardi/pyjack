...
def sum(x, axis=0):           return _apply_ufunc(numpy.sum, x, axis=axis)
def mean(x, axis=0):          return _apply_ufunc(numpy.mean, x, axis=axis)
def flip(x, axis=0):          return _apply_ufunc(numpy.flip, x, axis=axis)
def roll(x, axis=0, shift=0): return _apply_ufunc(numpy.roll, x, axis=axis, shift=shift)
def squeeze(x, axis=None):    return _apply_ufunc(numpy.squeeze, x, axis=axis)
def concatenate(x, axis=0):   return _apply_ufunc(numpy.concatenate, x, axis=axis)
